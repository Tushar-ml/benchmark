...
def get_full_command_shell_from_config(config: dict[str, Any]) -> str:
    """
...
if __name__ == "__main__":
    print(get_server_args("/home/ubuntu/benchmark/configs/glm-4p6/h200/sglang/config_2294.yaml"))